...
1.7.3ではSTREAM ERROR内のアナログFPV、大きく流れる色ノイズ、Play版の更新案内を追加し、PRO／保存画像ビューアーのアイコンを改善しました。[操作ガイド](docs/USAGE.ja.md)。
...
このソースは**1.7.3（versionCode 22）**です。オフラインの操作ガイドで撮影とFAULTの操作を確認できます。1.0.0からの更新時は旧エフェクト設定を初期化し、保存済みの作品は保持します。
