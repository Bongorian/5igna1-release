...
Canonical source: **https://github.com/Bongorian/5igna1-release**. Version 1.0.0 / code 8 is the first public release. Current source is the 1.2.0 / code 10 tutorial release. GitHub 1.1.0 / code 9 uses the existing main source. Existing 1.0.0 submissions, artifacts and tags remain unchanged. [Launch checklist](LAUNCH_TASKS.md)
...
For the 1.2.0 publication, attach these files after signing and verification:

```text
5igna1-v1.2.0.apk
5igna1-v1.2.0.apk.sha256
```
