...
Historical validation log through 1.3.0. Entries describe their dated test runs; “unreleased”, branch status, counts and pending checks are statements at that time. They do not describe the current source. See [current validation](../VALIDATION.md).

Unreleased work based on public release source `7dd83a7`, checked on 2026-09-08. [Japanese summary](VALIDATION_THROUGH_1_3_0.ja.md) · [Design and migration](../design/FAULT_SYSTEM.md). The [1.0.0 validation record](VALIDATION_1_0_0.md) is historical and does not establish physical-device coverage for this redesign.
