...
In the unreleased PRO workspace, the top toolbar contains light, save format, resolution/fps, AUTO/PRO and Settings. Location and audio controls occupy the single top toolbar and remain accessible when OFF. In landscape, capture controls sit to the right of the preview. Audio starts OFF; experimental RAW video is always silent. [PRO controls and layout inventory](PRO_CAMERA.md).
