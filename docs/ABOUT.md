...
[Back to 5igna1](../README.md) · [日本語](ABOUT.ja.md)

A sensor measures light, rows are read, components are reconstructed, and signals pass through encoding, media and display. At each point, something can shift, disappear, repeat or be misread. 5igna1 makes those possibilities an instrument for photography.
