...
- `images/phoneScreenshots`: 2026-09-08のfdroidDebug 1.0.0をAndroid Emulator API 37、カメラ `emulated`、1080×1920で実行。日英それぞれの実UIをADBで取得。01 CLEAN、02 ROW SHIFT、03 3段チェーン、04 調整。画像合成・UIの描き足しなし。
