...
/** Frozen renderer before uniform/state caching, for GPU output and timing comparisons. */
internal class EffectChainReference(private val source: String, private val supportsExternal: Boolean) {
