...
internal fun MainActivity.buildUi() {
    ...
    root.captureHome = FrameLayout(this)
    root.captureHome.addView(capture, FrameLayout.LayoutParams(dp(80f), dp(80f), Gravity.CENTER))
    controls.addView(root.captureHome, LinearLayout.LayoutParams(dp(80f), dp(80f)))
