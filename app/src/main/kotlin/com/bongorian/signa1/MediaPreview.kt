...
internal class MediaPreview(val a: MainActivity, val initial: Uri, val initialVideo: Boolean) {
    ...
    init {
        ...
        header.addView(title, LinearLayout.LayoutParams(0, a.dp(48f), 1f))
        external = a.button("↗")
        ...
        controls.addView(previous, LinearLayout.LayoutParams(a.dp(48f), a.dp(48f)))
        previous.setOnClickListener(OnClickListener@{ v: View? -> move(-1) })
        page = a.text("", 12, MainActivity.MUTED)
        page.setGravity(Gravity.CENTER)
        controls.addView(page, LinearLayout.LayoutParams(0, a.dp(48f), 1f))
        play = a.button("Ⅱ")
        play.setContentDescription(a.getString(R.string.live_pause))
        controls.addView(play, LinearLayout.LayoutParams(a.dp(48f), a.dp(48f)))
        ...
        val np = LinearLayout.LayoutParams(a.dp(48f), a.dp(48f))
